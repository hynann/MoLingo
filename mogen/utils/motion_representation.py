...
from mogen.utils.skeleton import Skeleton
import numpy as np
import os
from mogen.utils.quaternion import (
    qrot,
    qbetween_np,
    qrot_np,
    qfix,
...
from mogen.utils.paramUtil import t2m_raw_offsets, t2m_kinematic_chain
...
def _get_joints_to_guofeats():
    ...
    # skeleton_data = np.asarray(skeleton_data)
    # print("type:", type(skeleton_data))
    # if hasattr(skeleton_data, "files"):  # it's a .npz archive
    #     print("npz keys:", skeleton_data.files)
    #     skeleton_data = skeleton_data["arr_0"]  # or the correct key
    #
    # print("subtype:", type(skeleton_data))
    # print("dtype:", getattr(skeleton_data, "dtype", None))
    # print("shape:", getattr(skeleton_data, "shape", None))
    example_data = torch.from_numpy(skeleton_data)
    # example_data = torch.tensor(skeleton_data, dtype=torch.float32)
